...
function index() {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <p That class="mb-8 leading-relaxed">Hi, I'm Jethro Villarosa Teoxon, a 3rd-year Computer Science student with a passion for technology and software development. I'm currently honing my skills in programming, problem solving, and data structures, and am particularly excited
